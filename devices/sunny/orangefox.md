...
| **Recovery** | OrangeFox Recovery Project |
...
Each recovery is available as a bootable image or an installable ZIP. The recovery can be booted directly via Fastboot without being permanently flashed to the device.

| File | Description | Download |
|---|---|---|
| `orangefox-sunny.img` | Bootable image | [Download](https://github.com/PTX64/releases_sunny_recoveries/releases/download/latest/orangefox-sunny.img) |
| `orangefox-sunny.zip` | Installable ZIP | [Download](https://github.com/PTX64/releases_sunny_recoveries/releases/download/latest/orangefox-sunny.zip) |
