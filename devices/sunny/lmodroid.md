...
title: LMODroid — Download
---

![LMODroid Logo](/img/logos/LMODroid.webp)

> ⚠️ **This ROM has been discontinued.** No further updates will be released. Downloads remain available for reference only. Consider switching to [CrDroid+](/devices/sunny/crdroid/) or [LineageOS+](/devices/sunny/lineageos/) for an actively maintained alternative.
...
|---|---|---|
| `lmodroid-6.0-20250205-sunny.zip` | ROM package | [Download](https://github.com/PTX64/releases_sunny_lmodroid/releases/download/latest/lmodroid-6.0-20250205-sunny.zip) |
| `boot.img` | Boot image (required for first install) | [Download](https://github.com/PTX64/releases_sunny_lmodroid/releases/download/latest/boot.img) |
| `vendor_boot.img` | Vendor boot image (required for first install) | [Download](https://github.com/PTX64/releases_sunny_lmodroid/releases/download/latest/vendor_boot.img) |
