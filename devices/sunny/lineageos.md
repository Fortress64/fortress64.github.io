...
|---|---|---|
| `lineage-23.0-20251019-sunny.zip` | ROM package | [Download](https://github.com/PTX64/releases_sunny_lineageos/releases/download/latest/lineage-23.0-20251019-sunny.zip) |
| `boot.img` | Boot image (required for first install) | [Download](https://github.com/PTX64/releases_sunny_lineageos/releases/download/latest/boot.img) |
| `vendor_boot.img` | Vendor boot image (required for first install) | [Download](https://github.com/PTX64/releases_sunny_lineageos/releases/download/latest/vendor_boot.img) |
